...
CREATE UNIQUE INDEX "page_suggestion_infobox_changes_suggestion_id_infobox_section_id_index" ON "page_suggestion_infobox_changes" USING btree ("suggestion_id","infobox_section_id");--> statement-breakpoint
